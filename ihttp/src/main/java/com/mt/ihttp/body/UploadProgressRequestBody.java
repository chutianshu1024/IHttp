...
public class UploadProgressRequestBody extends RequestBody {
    ...
    protected final class CountingSink extends ForwardingSink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            //每20毫秒刷新一次数据,防止频繁无用的刷新
            if (curTime - lastRefreshUiTime >= 20 || bytesWritten == contentLength) {
                progressCallBack.onResponseProgress(bytesWritten, contentLength, (double) bytesWritten / contentLength, bytesWritten == contentLength);
