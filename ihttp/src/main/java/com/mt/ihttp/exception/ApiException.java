...
package com.mt.ihttp.exception;
...
public class ApiException extends Exception {
    ...
    public static boolean isOk(BaseResponse baseResponse) {
        if (baseResponse == null)
            return false;
        if (baseResponse.isSuccess() /*|| ignoreSomeIssue(apiResult.getCode())*/)
            return true;
        else
            return false;
    }
    ...
    public static class ERROR {
         ...
         * Gson解析异常
         */
        public static final int GSON_EXCEPTION = NULLPOINTER_EXCEPTION + 1;
    }
}